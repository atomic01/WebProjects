   <!DOCTYPE html>
    ...
    <body background="back.jpg">
      ...
      <form action="http://todolistapp.epizy.com/locastic/Drugi%20dio/ToDoList_App_Locastic/dashboard/logedin_user_add_list_process.php" method="POST">
      <div class="field-wrap">
            <label>
                Name the new list<span class="req">*</span>
            </label>
        <input type="text" required autocomplete="off" name="newlistname"/>
    </div>
      
      
          <button class="button" href>Add new list</button>
        </form>
