<!DOCTYPE html>
    ...
    <body background="back.jpg">
      ...
      <form action="http://todolistapp.epizy.com/locastic/Drugi%20dio/ToDoList_App_Locastic/dashboard/logedin_user_delete_task_process.php" method="POST">
      <div class="field-wrap">
            <label>
                Name the task to delete<span class="req">*</span>
            </label>
        <input type="text" required autocomplete="off" name="deletetask"/>
    </div>
    
      
          <button class="button" >Delete task</button>
          <h3 style="display: inline">Failed to delete task</h3>
        </form>
