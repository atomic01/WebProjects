<!DOCTYPE html>
    ...
    <body background="back.jpg">
      ...
      <form action="http://todolistapp.epizy.com/locastic/Drugi%20dio/ToDoList_App_Locastic/dashboard/logedin_user_edit_task_choices.php" method="POST">
      <div class="field-wrap">
            <label>
                Name the task to edit<span class="req">*</span>
            </label>
        <input type="text" required autocomplete="off" name="taskname"/>
    </div>
      
      
          <button class="button" href>Edit task</button>
          <h3 style="display: inline">Failed to find task</h3>
        </form>
