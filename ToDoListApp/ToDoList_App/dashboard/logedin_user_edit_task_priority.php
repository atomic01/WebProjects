<!DOCTYPE html>
    ...
    <body background="back.jpg">
      ...
      echo  '<h2 style="display: inline">'.$user->first_name.'</h2><br/><br/>
            ...
            <p style="display: inline">Task name: '.$_SESSION['taskname'].'</p>
            <p style="display: inline">Task deadline: '.$_SESSION['taskpriorityforecho'].'</p><br/><br/>';


      ?>

      <form action="http://todolistapp.epizy.com/locastic/Drugi%20dio/ToDoList_App_Locastic/dashboard/logedin_user_edit_task_priority_process.php" method="POST">
      <div class="field-wrap">
            <label>
                New task priority(Low, Medium or High)<span class="req">*</span>
            </label>
        <input type="text" required autocomplete="off" name="newpriority"/>
    </div>
