<!DOCTYPE html>
    ...
    <body background="back.jpg">
      ...
      echo  '<h2 style="display: inline">'.$user->first_name.'</h2><br/><br/>
            ...
            <p style="display: inline">Task deadline: '.$_SESSION['taskstatusforecho'].'</p><br/><br/>';


      ?>

      <form action="http://todolistapp.epizy.com/locastic/Drugi%20dio/ToDoList_App_Locastic/dashboard/logedin_user_edit_task_status_process.php" method="POST">
      <div class="field-wrap">
            <label>
                New task status(0 or 1)<span class="req">*</span>
            </label>
        <input type="number" required autocomplete="off" name="newstatus"/>
    </div>
